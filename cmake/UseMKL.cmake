if (USE_MKL)
    ...
    message('---[sik]-- trying to find FindMKL.cmake call A')
    find_package(MKL ${FIND_MODE}) # e.g FIND_MODE can be REQUIRED or QUIET
    message('---[sik]-- trying to find FindMKL.cmake call B')
    if (MKL_FOUND)
        message('---[sik]-- trying to find FindMKL.cmake call C')
    ...
    elseif(NOT FIND_MODE STREQUAL "REQUIRED") # case we were in Auto Mode
        message('---[sik]-- trying to find FindMKL.cmake call D')
        include_directories(${MKL_INCLUDE_DIR})
